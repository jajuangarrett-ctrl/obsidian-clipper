...
The local Task Manager handler can also be smoke-tested with an `obsidian://fjg-task-clipper` payload that creates a test task workspace and then appends an update to it.
